...
La Transformada de Hilbert $\hat{x}(t)$ de una señal $x(t)$ produce un **desfasaje de -90° para todas las frecuencias positivas** [source]:
...
La Transformada de Hilbert es un sistema LTI con funcion de transferencia [source]:
...
La señal analitica se construye combinando la señal original con su transformada [source]:
...
La señal SSB se genera usando la transformada de Hilbert [source]:
...
- ✓ NO cambia el contenido de frecuencias, solo las fases [source]
