...
Estas funciones son ortonormales: $\int_0^{T_s} \phi_i(t)\phi_j(t)dt = \delta_{ij}$ [source — [[../../outputs/derivations/QAM_comprehensive_20251116]]].
...
donde $I_n$ y $Q_n$ son las amplitudes de los componentes en fase y cuadratura [source — [[../../outputs/derivations/QAM_comprehensive_20251116]]].
...
para pulsos Nyquist ideales ($B = R_s$) [source — [[../../outputs/derivations/QAM_comprehensive_20251116]]].
...
Con codificación Gray: $P_b \approx P_s / \log_2(M)$ [source — [[../../outputs/derivations/QAM_comprehensive_20251116]]].
